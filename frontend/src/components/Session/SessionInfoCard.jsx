    ...
    <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
      ...
      <div className="mb-5">
        ...
        <div className="flex items-center space-x-2">
          ...
          <button
            ...
            className={`px-5 py-3 rounded-lg font-medium transition-all ${copiedRoomId ? "bg-green-500 text-white" : "bg-blue-600 text-white hover:bg-blue-700"}`}
          >
            {copiedRoomId ? (
      ...
      <div className="mb-5">
        ...
        <div className="flex items-center space-x-2">
          ...
          <button
            onClick={onCopyLink}
            className={`px-5 py-3 rounded-lg font-medium transition-all ${copiedLink ? "bg-green-500 text-white" : "bg-green-600 text-white hover:bg-green-700"}`}
          >
            {copiedLink ? "✓" : "Copy"}
          </button>
        </div>
