import { Code, Link as LinkIcon, Mail, Video, X } from "lucide-react";
            ...
            <div>
              ...
              <ul className="space-y-2">
                {APP_CONFIG.FOOTER_LINKS.QUICK_LINKS.map((link, index) => (
                  <li key={index}>
                    {link.isExternal ? (
                      <a className="hover:to-blue-400" href={link.route}>
                        {link.label}
                      </a>
                    ) : (
                      <Link to={link.route} className="hover:to-blue-400">
                        {link.label}
                      </Link>
                    )}
                  </li>
